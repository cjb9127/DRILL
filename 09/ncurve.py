...
def draw_curve_4_points(p1, p2, p3, p4):
    ...
    # for i in range(0, 50, 1):
    #     t = i / 100
    #     x = (2*t**2-3*t+1)*p4[0]+(-4*t**2+4*t)*p1[0]+(2*t**2-t)*p3[0]
    #     y = (2*t**2-3*t+1)*p4[1]+(-4*t**2+4*t)*p1[1]+(2*t**2-t)*p3[1]
    #     draw_point((x, y))
    # draw_point(p1)
def new_draw_curve_4_points(p1, p2, p3, p4):
    draw_big_point(p1)
    draw_big_point(p2)
    draw_big_point(p3)
    draw_big_point(p4)

    # p1-p2        2->1 3->2 4->3 1->4
    for i in range(0, 100, 1):
        t = i / 100
...
p1 = (100, 100-100); p2 = (-50, 400-100); p3 = (-200, -200-100); p4 = (400, -50-100)
...
new_draw_curve_4_points(p1, p2, p3, p4)
